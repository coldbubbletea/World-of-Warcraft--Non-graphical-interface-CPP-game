	...
	void produce()
	{
		...
		else if (seq==4)
		{
			if(life>=d.dragonLife)
			{
				...
				cout<<"It has a "<<weapon[(red_timer+1)%3]<<",and it's morale is ";
				cout << fixed <<setprecision(2)<<(1.0*life)/(1.0*d.dragonLife)<<endl;
			}
			seq=0;
		}
	...
	void produce()
	{
		...
		else if (seq==1)
		{
			if(life>=d.dragonLife)
			{
				...
				cout<<"It has a "<<weapon[(blue_timer+1)%3]<<",and it's morale is ";
				cout << fixed <<setprecision(2)<<(1.0*life)/(1.0*d.dragonLife)<<endl;
			}
			seq++;
		}
